...
public class ControladorSGR {
    ...
    public static List<SocioProtector> getSocioProtectores() {
    ...
    public static boolean agregaSocioProtector(SocioProtector nuevoSocioProtector) {
        if (socioProtectores.contains(nuevoSocioProtector)) {
            return false;
        } else {
            Historial.agregarRegistroSocio("null", "Nuevo SocPro");
    ...
    public void printSocios() {
        System.out.println("java.edu.uade.ioo.Socios Participes");
